(function () {
    ...
    SKU.prototype.init = function () {
        ...
        _this.warp.find('.sku_attr_select .btn').click(function () {
            ...
            if (!_dom.hasClass('btn-success')) {
                ...
                if (_dom.hasClass('Js_single_btn')) {
                    ...
                    _this.warp.find('.sku_attr_single').show();
        ...
        // [单规格]绑定input变化事件。放这里才正常。
        $('#goods_price').on('change', function() {
            _this.processSku();
        });
        $('#goods_price').on('keyup', function() {
            _this.processSku();
        });
        $('#goods_stock').on('change', function() {
            _this.processSku();
        });
        $('#goods_stock').on('keyup', function() {
            _this.processSku();
        });
